...
<script lang="ts">
  ...
  let languages = ['english', 'espagnol']
  let typeInput = ''
  ...
  <label class="modal-box w-[40rem] max-w-5xl h-[calc(100vh-13rem)] relative overflow-y-scroll" for="">
    <div class="w-full flex items-center mb-5">
     ...
     <form method="POST" >
       ...
       <button   formaction="?/setLanguage&language={language}"  class="w-full p-1 hover:bg-secondary flex items-center justify-start">
        {language}
           </button>
       {/each}
     </form>
